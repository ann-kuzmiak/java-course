...
public class Main {
    ...
    public static void OOPTask() {
        ...
        try {
            ...
            manager1.setCard("5802029494029299","13-05-2028","222","MasterCard");
            manager1.printCards();

            Broker broker1 = new Broker("Broker Name", "broker@gmail.com", "+380503139494");
            broker1.printUserInfo();
